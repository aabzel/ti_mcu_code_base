...
#define EXPECT_EQ(val1, val2)                                                                                          \
    do {                                                                                                               \
        ...
        /*int val2 = val2; */                                                                                          \
        if(val1 != val2) {                                                                                             \
            LOG_ERROR(SYS, "%s():Line: %d in val1: %"PRIu64" val2: %"PRIu64"", __FUNCTION__, __LINE__, val1, val2);                 \
            LOG_ERROR(SYS, "%s():Line: %d in val1: 0x%"PRIx64" val2: 0x%"PRIx64"", __FUNCTION__, __LINE__, val1, val2);             \
            return false;                                                                                              \
        } else {                                                                                                       \
            /*printf ("\n OK!\n");  */                                                                                 \
        }                                                                                                              \
