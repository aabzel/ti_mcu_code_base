...
#define TEST_SUIT_FLASH_FS                                                                                             \
    {"flash_fs_1", test_flash_fs_1}, {"flash_fs_2", test_flash_fs_2}, {"flash_fs_inval", test_flash_fs_inval},         \
        {"flash_fs_toggle", test_flash_fs_toggle}, {"flash_fs_3", test_flash_fs_3},
#ifdef __cplusplus
}
#endif
