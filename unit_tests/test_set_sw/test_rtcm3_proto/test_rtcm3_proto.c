...
const uint8_t rtcm3_message2[] = {0xD3, 0x00, 0x13, 0x3E, 0xD0, 0x00, 0x03,
                                  0x86, 0xA2, 0x16, 0xA1, 0x25, 0x85, 0x13,
                                  0x8B, 0xFB, 0xA2, 0x0C, 0x3C, 0xE2, 0x79,
                                  0x9D, 0x0C, 0x17, 0xFB, 0xD3, 0x00, 0x08,
                                  0x4C, 0xE0, 0x00, 0x8A, 0x00, 0x00, 0x00,
                                  0x00, 0xA8, 0xF7, 0x2A
};
...
bool test_rtcm3_array(void) {
    ...
    EXPECT_TRUE( rtcm3_proc_array(rtcm3_message2, sizeof(rtcm3_message2), RT_LORA_ID  ) );
