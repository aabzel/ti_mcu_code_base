...
static const uint8_t tbfp_message1[] = {0xA5, 0x00, 0x00, 0x00, 0x00, 0x2d};
static const uint8_t tbfp_message2[] = {0xA5, 0x01, 0x00, 0x00, 0x00, 0x00, 0x57};
static const uint8_t tbfp_message29[] = {0xA5, 0x1D, 0x00, 0x00, 0x00, 0x90, 0x73, 0xCB, 0xCB, 0x5E, 0x8A, 0xF8,
                                         0x00, 0x00, 0x80, 0xAE, 0xFE, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80,
                                         0x76, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x76, 0x40, 0x10};
...
bool test_tbfp_types(void) {
    ...
    printf("\n%s():", __FUNCTION__);
#endif
    EXPECT_EQ(5, sizeof(TbfHeader_t));
