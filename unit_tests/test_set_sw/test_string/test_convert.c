...
static const uint8_t ExpArray[128]={};

static const char arg1[]="";
...
bool test_convert_try_str_ascii2nimble(void) {
    uint8_t nibble=0xFF;
    EXPECT_FALSE(  AsciiChar2HexNibble('r', &nibble));
    EXPECT_FALSE(  AsciiChar2HexNibble('6', NULL));

    EXPECT_TRUE(  AsciiChar2HexNibble('1', &nibble));
    EXPECT_EQ(0x01, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('2', &nibble));
    EXPECT_EQ(0x02, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('3', &nibble));
    EXPECT_EQ(0x03, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('4', &nibble));
    EXPECT_EQ(0x04, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('5', &nibble));
    EXPECT_EQ(0x05, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('6', &nibble));
    EXPECT_EQ(0x06, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('7', &nibble));
    EXPECT_EQ(0x07, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('8', &nibble));
    EXPECT_EQ(0x08, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('9', &nibble));
    EXPECT_EQ(0x09, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('A', &nibble));
    EXPECT_EQ(0x0A, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('B', &nibble));
    EXPECT_EQ(0x0B, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('C', &nibble));
    EXPECT_EQ(0x0C, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('D', &nibble));
    EXPECT_EQ(0x0D, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('E', &nibble));
    EXPECT_EQ(0x0E, nibble);

    EXPECT_TRUE(  AsciiChar2HexNibble('F', &nibble));
    EXPECT_EQ(0x0F, nibble);
