...
/*crc24 0x244B24*/
const uint8_t rtcm3frame80[83]={0xD3, 0x00, 0x50,
0x43, 0xC0, 0x00, 0xD4, 0x8B, 0x66, 0x3E, 0x00, 0x00, 0x04,
0x02, 0x40, 0x80, 0x00, 0x00, 0x00, 0x00, 0x20, 0x80, 0x00,
0x00, 0x7F, 0xA6, 0xA2, 0x23, 0x21, 0x28, 0x23, 0x24, 0xD1,
0x9A, 0xE8, 0x9E, 0xAD, 0xA5, 0x8E, 0x6F, 0x18, 0x80, 0x3A,
0xB0, 0x44, 0x42, 0xA4, 0x44, 0x6A, 0x7A, 0x84, 0x95, 0xD4,
0x78, 0x0F, 0xB5, 0x51, 0xDE, 0xAD, 0x20, 0x80, 0xAD, 0x4B,
0xF8, 0x89, 0x98, 0x2D, 0xB7, 0x80, 0xA1, 0x48, 0xCD, 0x7F,
0xFF, 0xFF, 0x80, 0x4C, 0xFE, 0x36, 0x67, 0x84, 0xF0, 0x00};

/*crc24  0x0C17FB*/
const uint8_t rtcm3frame13[22]={0xD3, 0x00, 0x13 ,0x3E, 0xD0, 0x00, 0x03, 0x86, 0xA2, 0x16, 0xA1, 0x25, 0x85, 0x13, 0x8B, 0xFB, 0xA2, 0x0C, 0x3C, 0xE2, 0x79, 0x9D};

bool test_crc24q13(void) {
    uint32_t crc24 = 0;
    crc24 = calc_crc24_q(rtcm3frame13, sizeof(rtcm3frame13));
    EXPECT_EQ(0x0C17FB, crc24);
    EXPECT_TRUE( crc24_q_check(rtcm3frame13, sizeof(rtcm3frame13),  0x0C17FB) );
    return true;
}
...
bool test_crc24q80(void) {
    ...
    EXPECT_TRUE( crc24_q_check(rtcm3frame80, sizeof(rtcm3frame80),  0x244B24) );
    return true;
}
