...
#define TEST_SUIT_GPIO_GENERAL                                                                                         \
    /**/ {"gpio_wr_can_rst", test_gpio_write_can_rst}, /**/ {"gpio_wr_can_ss", test_gpio_write_can_ss},                  \
        /**/ {"gpio_wr_gnss_int", test_gpio_write_gnss_int}, /**/ {"gpio_wr_gnss_rst_n", test_gpio_write_gnss_rst_n},  \
        /**/ {"gpio_wr_gnss_safeboot", test_gpio_write_gnss_safeboot_n},                                               \
        /**/ {"gpio_wr_led_green", test_gpio_write_led_green}, /**/ {"gpio_wr_led_red", test_gpio_write_led_red},      \
        /**/ {"gpio_wr_ps_rs232", test_gpio_write_ps_rs232}, /**/ {"gpio_wr_sx1262_rst", test_gpio_write_sx1262_rst},  \
...
#define TEST_SUIT_GPIO_IO_BANG                                                                                         \
    /*1*/ {"gpio_wr_sclk", test_gpio_write_sclk}, /*2*/ {"gpio_wr_mosi", test_gpio_write_mosi},                        \
        /*3*/ {"gpio_wr_pwr_mux_ctrl", test_gpio_write_pwr_mux_ctrl},                                                  \
        /*4*/ {"gpio_wr_gnss_rxd", test_gpio_write_gnss_rxd}, /*5*/ {"gpio_wr_scl", test_gpio_write_batt_scl},         \
...
#define TEST_SUIT_GPIO                                                                                                 \
    ...
    TEST_SUIT_GPIO_IO_BANG{"gpio_write", test_gpio_write},
