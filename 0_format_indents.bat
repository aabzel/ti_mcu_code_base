...
%format_tool%  -verbose -i -style=%style1% %work_space_dir%\Drivers\sx1262\legal_band.h
...
%format_tool%  -verbose -i -style=%style1% %work_space_dir%\projects\fw_loader_debug\fw_update.h
