...
static void dtoa_normal(double_t double_data, int32_t double_precision,
                        char double_stringified[]);
...
static void dtoa_normal(double_t double_data, int32_t double_precision,
  ...
  if (d_precision == 0) {
    (void)utoa64_((uint64_t)double_d,
                  &double_stringified[double_result_str_index], 10U, NULL);
  } else {
    uint64_t double_int_part = (uint64_t)double_d;
    uint32_t double_int_part_len = 0U;
    double_d -= (double_t)double_int_part;
    (void)utoa64_(double_int_part, &double_stringified[double_result_str_index],
                  10U, &double_int_part_len);
