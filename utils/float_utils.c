...
bool is_floats_equal(float valA, float valB) {
  return is_float_equal_relative(valA, valB, (float)F_EPSILON);
}
...
bool is_float_equal_relative(float a__fife, float b__fife,
  ...
  if (fabsf(a__fife - b__fife) <=
      fmaxf(fabsf(relative_epsilon__fife * b__fife),
            fabsf(relative_epsilon__fife * a__fife))) {
    retval__fife = true;
  } else {
    retval__fife = false;
  }
...
bool is_double_equal_relative(double a__fide, double b__fide,
  ...
  bool retval__fide;
  if (fabs(a__fide - b__fide) <= fmax(fabs(relative_epsilon__fide * b__fide),
                                      fabs(relative_epsilon__fide * a__fide))) {
    retval__fide = true;
  } else {
    retval__fide = false;
  }
