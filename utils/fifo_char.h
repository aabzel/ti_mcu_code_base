...
bool fifo_push_array(Fifo_array_t *const instance, char *const inArr,
                     uint16_t arrLen);
bool fifo_pull_array(Fifo_array_t *const instance, char *const outArr,
                     uint16_t *const outLen);
bool fifo_peek_array(Fifo_array_t *const instance, char *const outArr,
                     uint16_t *const outLen);
